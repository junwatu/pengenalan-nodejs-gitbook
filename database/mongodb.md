...
Klien bisa berinteraksi langsung dengan database MongoDB dengan menggunakan JavaScript bahkan tool terminal `mongo` bisa juga mengeksekusi program JavaScript. Sebagai contoh
