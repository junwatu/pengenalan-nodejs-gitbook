...
Intinya adalah dengan metode ini kita bisa memakai SQL statemen yang biasa dipakai untuk query data di MySQL jadi penggunaana modul npm ini cukup mudah.
